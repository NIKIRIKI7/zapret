    ...
    def __init__(self, initial_text: str = "", parent=None, language: str = "ru"):
        ...
        if HAS_FLUENT:
            self._title_lbl = SubtitleLabel(
                tr_text(self._ui_language, "page.z2_strategy_detail.args_dialog.title", "Аргументы стратегии")
            )
        else:
        ...
        if HAS_FLUENT:
            ...
            hint = QLabel(
                tr_text(self._ui_language, "page.z2_strategy_detail.args_dialog.hint.short", "Один аргумент на строку.")
            )
        ...
        self.yesButton.setText(
            tr_text(self._ui_language, "page.z2_strategy_detail.args_dialog.button.save", "Сохранить")
        )
        self.cancelButton.setText(
            tr_text(self._ui_language, "page.z2_strategy_detail.args_dialog.button.cancel", "Отмена")
        )
...
class ElidedLabel(QLabel):
    ...
    def __init__(self, text: str = "", parent=None):
        # Держим реальный текст отдельно и рисуем его сами.
        # Так label ведет себя стабильнее на длинных строках в шапке страницы.
        super().__init__("", parent)
