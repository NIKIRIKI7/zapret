...
PAGE_PERFORMANCE_PROFILES: dict[PageName, PagePerformanceProfile] = {
    ...
    PageName.ZAPRET2_DIRECT_CONTROL: _profile("heavy_list", "ui", 200),
    ...
    PageName.ZAPRET2_ORCHESTRA_CONTROL: _profile("heavy_list", "ui", 200),
    ...
    PageName.ZAPRET1_DIRECT_CONTROL: _profile("heavy_list", "ui", 200),
    ...
    PageName.BLOBS: _profile("data", "module", 120),
